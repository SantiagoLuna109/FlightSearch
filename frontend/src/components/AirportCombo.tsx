...
export default function AirportCombo({ label, value, onChange }: Props) {
  ...
  const formatLabel = (a: Airport) =>
    `${a.city}${a.country ? ', ' + a.country : ''} — ${a.name}`
    ...
    <Combobox value={selected} onChange={handleSelect} nullable>
      <div className="flex flex-col">
        ...
        <div className="relative">
          ...
          <Combobox.Options className="absolute z-10 mt-1 max-h-60 w-full overflow-auto rounded bg-white shadow-lg ring-1 ring-black/5">
